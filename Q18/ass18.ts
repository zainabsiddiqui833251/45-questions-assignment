...
let favouritePlaces:string[] = ["Turkey" , "Germany" , "Canada" , "Kashmir" , "Holland"];
...
let alphabeticalorder = [...favouritePlaces].sort();
console.log(alphabeticalorder);

let reversealphabeticalorder = [...favouritePlaces].sort().reverse();
