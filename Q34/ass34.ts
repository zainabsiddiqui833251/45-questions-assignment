...
should consist of three or more lines about the kinds of pizza you like and then an additional sentence, such as
 ...
 let pizzas : string[] = ['malai boti' , 'extra cheese' , 'tikka boti']
 ...
 console.log("Chicken Malai Boti, also known as Chicken Malai Tikka, traces its origins back to the Mughal court in Delhi, where Central Asian and Persian food traditions mingled with those of India to produce what is known as Mughlai cuisine" + "I really love pizza :)")
